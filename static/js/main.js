...
var bigSkin, bigSkins, currSkinIndex, fontProps, fontShadowProps, iphone, leftEye, leftPupilRed, mouth, paper, redFill, rightEye, rightPupilRed, shapeShadow, skinColors, t1, t2, t3, talkBubble, whiteFill, x, _i;
...
talkBubble = paper.path("M250,70c0,5.523-4.125,10-9.213,10H28.888c-5.088,0-9.213-4.477-9.213-10V51.92L0,38.293l19.675-13.541V10  c0-5.523,4.125-10,9.213-10h211.899C245.875,0,250,4.477,250,10V70z").attr({
  fill: colors.liteYellow,
  stroke: 'none'
}).transform('t9,10').glow(shapeShadow);

paper.text(45, 51, "You complete me.").attr(fontShadowProps).attr({
  'font-size': 24
});

paper.text(44, 50, "You complete me.").attr(fontProps).attr({
  'font-size': 24
});

paper.text(35, 300, "Create your own Critters\nwith multi-colored\npaper skins\nand self-adhesive\ndetails.").attr(fontProps).attr({
  "font-size": 24
});
