...
var bp, bs, getRotationValue, paper, registerMovable, shapeRegistry, skinColors, ss, sss, touchTransform, verticalOffset, verticalSpacer, x, _i;

paper = Raphael("bigSkin", 800, 310);

paper.canvas.setAttribute('id', 'bigSkin');

bs = paper.bigSkinPath().attr({
  fill: colors.green,
  stroke: 'none'
});
...
skinColors = ['pink', 'blue', 'purple', 'green', 'yellow', 'orange', 'liteBlue', 'liteGreen'];

sss = [];

for (x = _i = 0; _i <= 7; x = ++_i) {
  ss = paper.smallSkinPath().attr({
